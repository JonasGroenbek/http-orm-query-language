...
The language is designed to be simple and easy to use, and it is targetting relational databases. The language itself is used to structure a single query string which is then parsed and converted into a query object which is then used to generate SQL. 
